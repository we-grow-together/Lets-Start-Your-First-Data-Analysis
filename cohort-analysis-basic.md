...
또는 시간 단위 코호트로 퍼널 분석을 하고자 하는데 유동인구와 내방객의 수를 일 단위로만 집계하고 내방객 기록 데이터를 모두 지워 버렸다면 시간 단위 코호트 분석은 할 수 없을 겁니다. 그래서 당장은 필요 없어 보이는 데이터라고 하더라도 일정 기간은 보관하고 있어야 합니다. 
